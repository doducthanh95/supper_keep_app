...
class AppColors {
  ...
  static Color backgroundPri = fromHex('#141326');
  static Color backgroundSecond = fromHex('#23203F');
  static Color yellow500 = fromHex('#E3B53C');
  static Color yellow400 = fromHex('#E3B53C').withOpacity(0.8);
  static Color yellow300 = fromHex('#E3B53C').withOpacity(0.5);

  static Color orange500 = fromHex('#E33C3C');
  static Color orange400 = fromHex('#E33C3C').withOpacity(0.8);
  static Color orange300 = fromHex('#E33C3C').withOpacity(0.5);
